(function() {
  ...
  */
  ...
  const operation = justMod2Or3.reduce(( acum, item ) => {
    return (acum + 1) * item;
  }, 0);
  ...
  */
  ...
  const newOperation = justMod2Or3.reduceRight(( acum, item ) => {
    return (acum + 1) * item;
  }, 0);
  ...
  */
  ...
  const pName = name.reduce(( acum, item ) => {
    return `${acum}p${item}`;
  }, '');
  ...
  */
  ...
  const inversedName = name.reduceRight(( acum, item ) => {
    return acum + item;
  });
