...
(function( window, document ) {
	...
	let $buttonStart = document.querySelector('[data-js="buttonStart"]');
	let $buttonStop = document.querySelector('[data-js="buttonStop"]');
	let $buttonReset = document.querySelector('[data-js="buttonReset"]');
	...
	function startTimer() {
		...
		clearTimer = setTimeout( startTimer, 1000 );
	}
