(function() {
  ...
  */
  ...
  - pegando uma sequência de caracteres --> texto.match(/[A-Za-z0-9]/gi) --> equivale a texto.match(/\w/gi)
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/, 'Simone Amorim Silva'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, ( texto ) => {
