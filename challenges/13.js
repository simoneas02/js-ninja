(function() {
  ...
  */
  ...
  const someBrasil = brasil.some(( item ) => {
    return 'Ceará' === item;
  });

  console.log( someBrasil ? 'Ceará está incluído!' : 'Ceará não foi incluído :(')
  ...
  */
  const map = brasil.map(( item, index ) => {
    return {
       id: index +1,
